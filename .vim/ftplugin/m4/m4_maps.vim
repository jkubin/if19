...
iabbrev <buffer> d0 divert(0)dnl<cr><c-u><c-r>=Eatchar('\s')<cr>
...
iabbrev <buffer> dea define([], defn([%%%]))<c-o>T(<c-o>;<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> deb # β<cr><c-u>define([], [<cr><cr><tab>%%%<cr><c-d>])<up><up><up><c-o>f]<c-r>=Eatchar('.')<cr>
iabbrev <buffer> dec decr($1)
iabbrev <buffer> ded define([], defn([%%%]))<c-o>T(<c-o>;<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> de define([], [%%%])<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> dee define(`', `%%%')<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> def # A → β<cr><c-u>define([], [<cr><cr><tab>%%%<cr><c-d>])<up><up><up><c-o>f]<c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> det define([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> detr define([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> df <left>defn(<right><right>)<left><left><c-r>=Eatchar('.')<cr>
iabbrev <buffer> dfn defn([])<left><left><c-r>=Eatchar('.')<cr>
iabbrev <buffer> di0 divert(0)dnl<cr><c-u><c-r>=Eatchar('\s')<cr>
iabbrev <buffer> di divert()dnl0<c-d><c-o>T(<c-r>=Eatchar('.')<cr>
iabbrev <buffer> dii divert(-1)0<c-d><c-r>=Eatchar('\s')<cr>
iabbrev <buffer> din divert(1)dnl0<c-d><c-o>T1<esc><c-r>=Eatchar('.')<cr>
iabbrev <buffer> dio divert(0)dnl<cr><c-u><c-r>=Eatchar('\s')<cr>
iabbrev <buffer> diven divert(1)dnl0<c-d><c-o>T(<esc><c-r>=Eatchar('.')<cr>
iabbrev <buffer> divn divnum<c-r>=Eatchar('\s')<cr>
iabbrev <buffer> dn dnl<c-r>=Eatchar('\s')<cr>
...
iabbrev <buffer> ife ifelse([$1], [%%%], [%%%], [%%%])<c-o>F$<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> ifel ifelse(<cr><tab>[$%%%], [%%%], [%%%],<cr>[$%%%], [%%%], [%%%],<cr>[$%%%], [%%%], [%%%],<cr>[%%%]dnl<cr>)<c-o><<<left><c-o>%<right><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> pop popdef([])<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> popd popdef(<cr><tab>[%%%],<cr>[%%%],<cr>[%%%],<cr><c-d>)<up><up><up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> pt pushdef([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> pu pushdef([])<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> push pushdef([], [%%%])<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> pus pushdef([])<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> put pushdef([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> putr pushdef([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> tra define([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> tran # transition to the next node<cr><c-u>define([$0], defn([]))<c-o>T(<right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> ud undivert()dnl<c-o>T(<c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> und undivert()dnl<c-o>T(<c-r>=Eatchar('.')<cr>
iabbrev <buffer> une undefine([])<left><left><c-r>=Eatchar('.')<cr>
iabbrev <buffer> unn undivert(1)dnl<c-o>T1<esc><c-r>=Eatchar('.')<cr>
